...
| **NER** | Extract named entities | People, places, orgs |
...
- Keep only top k singular values (k << r, typically k = 100-300)
...
|------|-------------|---------|
| **NER** | Find named entities | "Apple Inc." → Organization |
...
| Specific information | Relevant documents |
